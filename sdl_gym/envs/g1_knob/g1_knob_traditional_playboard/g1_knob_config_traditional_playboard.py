from sdl_gym.envs.g1_knob.g1_knob_traditional_playboard.g1_robot_config_traditional_playboard import G1RobotCfg, G1RobotCfgPPO

class G1KnobCfg_traditional_playboard( G1RobotCfg ):
...
class G1KnobCfgPPO_traditional_playboard( G1RobotCfgPPO ):
    class policy:
        init_noise_std = 0.8
