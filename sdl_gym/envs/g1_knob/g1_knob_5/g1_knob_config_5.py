from sdl_gym.envs.g1_knob.g1_knob_5.g1_robot_config_5 import G1RobotCfg, G1RobotCfgPPO

class G1KnobCfg_5( G1RobotCfg ):
    ...
    class asset_g1( G1RobotCfg.asset_g1 ):
        file = '{SDL_GYM_ROOT_DIR}/resources/robots/g1_description/g1_29dof_with_hand_base_at_torso.urdf'
        name = "g1"
...
class G1KnobCfgPPO_5( G1RobotCfgPPO ):
    class policy:
        init_noise_std = 0.8
