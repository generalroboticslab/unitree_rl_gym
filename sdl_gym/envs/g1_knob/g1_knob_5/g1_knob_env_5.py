from sdl_gym.envs.g1_knob.g1_knob_5.g1_robot_5 import G1Robot
...
from .g1_robot_config_5 import G1RobotCfg
from ....utils import factory_control as fc


class G1KnobRobot_5(G1Robot):
    ...
    def _init_data(self):
        ...
        local_knob_hand_reach_pose.r =  gymapi.Quat.from_euler_zyx(0, 0, 0.5 * np.pi)
    ...
    def pre_physics_step(self, actions):
        ...
        self.real_dof_control_pos_target[:, :self.right_arm_dofs_num] = tensor_clamp(
             self.real_dof_control_pos_target[:, :self.right_arm_dofs_num], self.dof_pos_limits[self.right_shoulder_pitch_joint_handle:self.right_wrist_yaw_joint_handle+1, 0], self.dof_pos_limits[self.right_shoulder_pitch_joint_handle:self.right_wrist_yaw_joint_handle+1, 1]
         )
    ...
    def _compute_dof_tartget_pos(self, actions):
        ...
        self.input_sim_actions_vectors[:, self.right_shoulder_pitch_joint_handle:self.right_wrist_yaw_joint_handle+1] = actions[:, :self.right_arm_dofs_num]
