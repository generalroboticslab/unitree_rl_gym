...
wall_length = (18 * ureg.inch).to(ureg.mm).magnitude
wall_height = (24 * ureg.inch).to(ureg.mm).magnitude
knob_holder_thickness = (15 * ureg.mm).magnitude
knob_1_to_wall_bottom_line_dist = (14.406 * ureg.inch).to(ureg.mm).magnitude
knob_1_to_wall_side_line_dist = (3.135 * ureg.inch).to(ureg.mm).magnitude
knob_to_knob_center_dist = (3.937 * ureg.inch).to(ureg.mm).magnitude


wall_link = Link(
    Visual(
        Origin(xyz=[0, wall_length, 0], rpy=[0, 0, np.pi]),
        Geometry(Mesh(filename="meshes/wall.stl", scale="1 1 1")),
        wood,
    ),
    Collision(
        Origin(xyz=[0, wall_length, 0], rpy=[0, 0, np.pi]),
...
knob_holder_1 = Link(
    Visual(
        ...
        Geometry(Mesh(filename="meshes/knob_holder_1.stl", scale="1 1 1")),
        grey,
    ),
    Collision(
        Origin(xyz=[knob_holder_thickness, knob_1_to_wall_side_line_dist, knob_1_to_wall_bottom_line_dist], rpy=[0, 0, - np.pi / 2]),
...
knob_1 = Link(
    Visual(
        ...
        Geometry(Mesh(filename="meshes/knob_1.stl", scale="1 1 1")),
        black,
    ),
    Collision(
        Origin(xyz=[0, 0, 0], rpy=[0, np.pi / 2, 0]),
...
knob_1_joint = Joint(
    ...
    Child(knob_1),
    Origin(xyz=[knob_holder_thickness + 26, knob_1_to_wall_side_line_dist, knob_1_to_wall_bottom_line_dist], rpy=[0, 0, 0]),
    Axis(xyz=[1, 0, 0]),
...
knob_holder_2 = Link(
    Visual(
        ...
        Geometry(Mesh(filename="meshes/knob_holder_2.stl", scale="1 1 1")),
        grey,
    ),
    Collision(
        Origin(xyz=[knob_holder_thickness, knob_1_to_wall_side_line_dist + knob_to_knob_center_dist, knob_1_to_wall_bottom_line_dist], rpy=[0, 0, - np.pi / 2]),
...
knob_2 = Link(
    Visual(
        Origin(xyz=[0, 0, 0], rpy=[0, np.pi / 2, 0]),
        Geometry(Mesh(filename="meshes/knob_2.stl", scale="1 1 1")),
        black,
    ),
    Collision(
        Origin(xyz=[0, 0, 0], rpy=[0, np.pi / 2, 0]),
...
knob_2_joint = Joint(
    ...
    Child(knob_2),
    Origin(xyz=[knob_holder_thickness + 12, knob_1_to_wall_side_line_dist + knob_to_knob_center_dist, knob_1_to_wall_bottom_line_dist], rpy=[0, 0, 0]),
    Axis(xyz=[1, 0, 0]),
    Limit(effort=2, velocity=5, lower=0, upper=2 * np.pi),
    Dynamics(friction=0.01, damping=0),
    type="revolute",
...
knob_holder_3 = Link(
    Visual(
        ...
        Geometry(Mesh(filename="meshes/knob_holder_3.stl", scale="1 1 1")),
        grey,
    ),
    Collision(
        Origin(xyz=[knob_holder_thickness, knob_1_to_wall_side_line_dist + 2 * knob_to_knob_center_dist, knob_1_to_wall_bottom_line_dist], rpy=[0, 0, - np.pi / 2]),
...
knob_3 = Link(
    Visual(
        Origin(xyz=[0, 0, 0], rpy=[0, np.pi / 2, 0]),
        Geometry(Mesh(filename="meshes/knob_3.stl", scale="1 1 1")),
        black,
    ),
    Collision(
        Origin(xyz=[0, 0, 0], rpy=[0, np.pi / 2, 0]),
...
knob_3_joint = Joint(
    ...
    Child(knob_3),
    Origin(xyz=[knob_holder_thickness + 12, knob_1_to_wall_side_line_dist + 2 * knob_to_knob_center_dist, knob_1_to_wall_bottom_line_dist], rpy=[0, 0, 0]),
    Axis(xyz=[1, 0, 0]),
    Limit(effort=2, velocity=5, lower=0, upper=2 * np.pi),
    Dynamics(friction=0.01, damping=0),
    type="revolute",
